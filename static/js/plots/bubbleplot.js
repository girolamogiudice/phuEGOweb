/* BUBBLE PLOT */
function renderD3BubblePlot(rows, svg, opts = {}) {
    clearSVG(svg);
  ...
  const barHeight = 35;
  const margin = { top: 20, right: 150, bottom: 80, left: 320 };
  ...
  const gradientId = 'bubble-gradient-' + Math.random().toString(36).slice(2, 9);
